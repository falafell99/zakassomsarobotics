...
ULTRASONIC_STOP_M = float(os.getenv("ULTRASONIC_STOP_M", "0.50"))
...
SENSOR_WALL_THRESHOLD_M = float(os.getenv("SENSOR_WALL_THRESHOLD_M", "1.2"))
SCENE_PROFILE = os.getenv("SCENE_PROFILE", "home_office")

SPEAK_ENABLED = os.getenv("SPEAK_ENABLED", "true").lower() == "true"
TTS_REPEAT_SECONDS = float(os.getenv("TTS_REPEAT_SECONDS", "12.0"))
TTS_DANGER_REPEAT_SECONDS = float(os.getenv("TTS_DANGER_REPEAT_SECONDS", "3.0"))
TTS_DISTANCE_DELTA_M = float(os.getenv("TTS_DISTANCE_DELTA_M", "0.6"))
